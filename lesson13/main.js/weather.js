const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=3530103&units=imperial&appid=3857ba2acf06e72d887f7365beccbbad";
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    document.getElementById('high').textContent = jsObject.main.temp.toFixed(0) + "°F ";
  ...
  const dayForecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=3530103&appid=3857ba2acf06e72d887f7365beccbbad&units=imperial";
fetch(dayForecastURL)
  ...
  .then((jsObject) => {
    ...
    /* I want to
       create a smaller list with only objects that are at 6:00, 12:00:00*/
